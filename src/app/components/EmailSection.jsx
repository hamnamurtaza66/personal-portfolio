  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await emailjs.sendForm(
        "service_0k7bkie",        // ✅ Your EmailJS Service ID
        "template_kvof6h2",       // ✅ Your EmailJS Template ID
        e.target,                 // ✅ Directly pass form data
        "l4G1X6ncG5GQHVQRs"       // ✅ Your EmailJS Public Key
      );
    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          We are always open to discussing new opportunities and collaborations.
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/hamnamurtaza66" target="_blank">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/hamnamurtaza/" target="_blank">
